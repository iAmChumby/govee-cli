...
export function ConfigRow({
  ...
  return (
    <div className="flex items-center justify-between gap-4 py-2.5 first:pt-0 last:pb-0">
      <span className="text-[11px] uppercase leading-none tracking-micro text-mid">{label}</span>
      <span className="min-w-0 truncate font-mono text-[12px] tabular-nums text-mid">
        {children}
      </span>
    </div>
  );
